...
int main() {
	...
	ZNAK arrayZnak[N];
	puts("Добро пожаловать в книгу зодиаков, давайте приступим к работе!");
...
/*
в этой версии необходимо добавить функцию поиска по дате рождения, а также arrayZnak == book
а также сделать редактор выввода
*/